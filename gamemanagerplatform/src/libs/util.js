...
util.postAdminJsonData=function(router,params,_this,cb){
    this.postJsonData(router,Object.assign(params,{loginId:this.loginId,token:this.token}),_this,cb);
};

util.getAdminJsonData=function(router,params,_this,cb){
    this.getJsonData(router,Object.assign(params,{loginId:this.loginId,token:this.token}),_this,cb);
};
export default util;
